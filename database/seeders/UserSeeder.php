...
class UserSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $permissions = [
            ...
            ['name' => 'create tasks', 'guard_name' => 'web', 'created_at' => date('Y-m-d H:i:s'), 'updated_at' => date('Y-m-d H:i:s')],
            ['name' => 'edit tasks', 'guard_name' => 'web', 'created_at' => date('Y-m-d H:i:s'), 'updated_at' => date('Y-m-d H:i:s')],
            ['name' => 'view tasks', 'guard_name' => 'web', 'created_at' => date('Y-m-d H:i:s'), 'updated_at' => date('Y-m-d H:i:s')],
            ['name' => 'delete tasks', 'guard_name' => 'web', 'created_at' => date('Y-m-d H:i:s'), 'updated_at' => date('Y-m-d H:i:s')],
            ['name' => 'manage tasks', 'guard_name' => 'web', 'created_at' => date('Y-m-d H:i:s'), 'updated_at' => date('Y-m-d H:i:s')],
            ...
            ['name' => 'timeline case', 'guard_name' => 'web', 'created_at' => date('Y-m-d H:i:s'), 'updated_at' => date('Y-m-d H:i:s')],
            ['name' => 'calendar case', 'guard_name' => 'web', 'created_at' => date('Y-m-d H:i:s'), 'updated_at' => date('Y-m-d H:i:s')],
            ['name' => 'calendar create case', 'guard_name' => 'web', 'created_at' => date('Y-m-d H:i:s'), 'updated_at' => date('Y-m-d H:i:s')],
            ['name' => 'calendar edit case', 'guard_name' => 'web', 'created_at' => date('Y-m-d H:i:s'), 'updated_at' => date('Y-m-d H:i:s')],
            ['name' => 'calendar delete case', 'guard_name' => 'web', 'created_at' => date('Y-m-d H:i:s'), 'updated_at' => date('Y-m-d H:i:s')],

            ['name' => 'tasks case', 'guard_name' => 'web', 'created_at' => date('Y-m-d H:i:s'), 'updated_at' => date('Y-m-d H:i:s')],
        ...
        $companyPermissions = [
            ...
            ["name" => "timeline case"],
            ["name" => "calendar case"],
            ["name" => "calendar create case"],
            ["name" => "calendar edit case"],
            ["name" => "calendar delete case"],
            ["name" => "tasks case"],
        ];
        ...
        $company = User::create(
            [
                ...
                'created_by' => 1,
                'google_calendar_id' => 'ng1a0u9quobg81d7bc307qsh6k@group.calendar.google.com',
            ]
        );
        $detail = new UserDetail();
        ...
        $company->MakeRole($company->id,'co-Admin');
        // $company->MakeRole($company->id,'advocate');
        // $company->MakeRole($company->id,'client');
        $company->MakeRole($company->id,'staff');
        ...
        $userController->groupAddOrUpdate(array($client->id,$advocate->id),'add',$company->id);
    }
}
