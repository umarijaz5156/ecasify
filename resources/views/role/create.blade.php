                    ...
                    <div class="table-border-style">
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                ...
                                <tbody>
                                    @php
                                        // $modules=['dashboard','advocate','document','doctype','member','group','court','highcourt','bench','cause','case','tasks','bill','tax','diary','timesheet','expense','feereceived','appointment','calendar','setting'];
                                            ...
                                            <td width="10%">
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input ischeck"
                                                        name="checkall" data-id="{{ str_replace(' ', '', $module) }}" id="{{ str_replace(' ', '', $module) }}">
                                                </div>
                                            </td>
                                            <td width="10%">
                                                <label class="ischeck"
                                                ...
                                                <div class="row">
                                                    @if (in_array('manage ' . $module, (array) $permissions))
                                                        @if ($key = array_search('manage ' . $module, $permissions))
                                                            <div class="col-md-3 form-check">
                                                                {{ Form::checkbox('permissions[]', $key, false, ['class' => 'form-check-input isscheck isscheck_' . str_replace(' ', '', $module), 'id' => 'permission' . $key, 'data-id' => str_replace(' ', '', $module),'data-field'=> 'visible']) }}
                                                    ...
                                                    @if (in_array('create ' . $module, (array) $permissions))
                                                        @if ($key = array_search('create ' . $module, $permissions))
                                                            <div class="col-md-3 form-check">
                                                                {{ Form::checkbox('permissions[]', $key, false, ['class' => 'form-check-input isscheck isscheck_' . str_replace(' ', '', $module), 'id' => 'permission' . $key, 'data-id' => str_replace(' ', '', $module)]) }}
                                                    ...
                                                    @if (in_array('calendar ' . $module, (array) $permissions))
                                                        @if ($key = array_search('calendar ' . $module, $permissions))
                                                            <div class="col-md-3 form-check">
                                                                {{ Form::checkbox('permissions[]', $key, false, ['class' => 'form-check-input isscheck isscheck_' . str_replace(' ', '', $module), 'id' => 'permission' . $key, 'data-id' => str_replace(' ', '', $module),'data-field' => 'calendar']) }}
                                                    ...
                                                    @if (in_array('calendar create ' . $module, (array) $permissions))
                                                        @if ($key = array_search('calendar create ' . $module, $permissions))
                                                            <div class="col-md-3 form-check">
                                                                {{ Form::checkbox('permissions[]', $key, false, ['class' => 'form-check-input isscheck isscheck_' . str_replace(' ', '', $module), 'id' => 'permission' . $key, 'data-id' => str_replace(' ', '', $module),'data-field' => 'calendar_create']) }}
                                                    ...
                                                    @if (in_array('calendar edit ' . $module, (array) $permissions))
                                                        @if ($key = array_search('calendar edit ' . $module, $permissions))
                                                            <div class="col-md-3 form-check">
                                                                {{ Form::checkbox('permissions[]', $key, false, ['class' => 'form-check-input isscheck isscheck_' . str_replace(' ', '', $module), 'id' => 'permission' . $key,'data-field' => 'calendar_edit']) }}
                                                    ...
                                                    @if (in_array('calendar delete ' . $module, (array) $permissions))
                                                        @if ($key = array_search('calendar delete ' . $module, $permissions))
                                                            <div class="col-md-3 form-check">
                                                                {{ Form::checkbox('permissions[]', $key, false, ['class' => 'form-check-input isscheck isscheck_' . str_replace(' ', '', $module), 'id' => 'permission' . $key,'data-field' => 'calendar_delete']) }}
                                                    ...
                                                    @if (in_array('buy ' . $module, (array) $permissions))
                                                        @if ($key = array_search('buy ' . $module, $permissions))
                                                            <div class="col-md-3 form-check">
                                                                {{ Form::checkbox('permissions[] isscheck isscheck_' . str_replace(' ', '', $module), $key, false, ['class' => 'form-check-input', 'id' => 'permission' . $key, 'data-id' => str_replace(' ', '', $module)]) }}
