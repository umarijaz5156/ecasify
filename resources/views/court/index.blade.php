...
@section('page-title', __('Court'))

@section('action-button')
    @can('create court')
        <div class="text-sm-end d-flex all-button-box justify-content-sm-end">
            <a href="#" class="btn btn-sm btn-primary mx-1" data-ajax-popup="true" data-size="md" data-title="Add Court"
                data-url="{{ route('courts.create') }}" data-toggle="tooltip" title="{{ __('Create New Court') }}" data-bs-original-title="{{__('Create New Court')}}" data-bs-placement="top" data-bs-toggle="tooltip">
...
@section('breadcrumb')
    <li class="breadcrumb-item">{{ __('Court') }}</li>
@endsection
