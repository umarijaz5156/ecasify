                ...
                <div class="table-responsive">
                    <table class="table dataTable data-table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td><a href="#" class="btn btn-sm" data-url="{{ route('cause.show', $caus->id) }}" data-size="md" data-ajax-popup="true"
                                    data-title="{{ __('View CauseList') }}">

                                    {{$caus->causelist_by}} - {{ $caus->advocate_name }}
                                </a></td>
                                <td> {{ $caus->getCourtById($caus->court) }} </td>
                                <td> {{ $caus->getHighCourtById($caus->highcourt) }} </td>
                                <td> {{ $caus->getBenchById($caus->bench) }} </td>
                                <td>
