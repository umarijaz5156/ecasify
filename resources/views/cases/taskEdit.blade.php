                    ...
                    <div class="mb-3" style="max-width: 380px; width: 100%;">
                        <div class="form-group">
                            ...
                            <div class="input-group justify-content-start add_modal_input">
                                {{ Form::text('date', old('date'), ['class' => 'form-control ', 'id' => 'Task_Date_edit', 'autocomplete' => 'off', 'placeholder' => 'YYYY-MM-DD', 'required' => true]) }}
                                <span
...
<script>
        ...
        var incidentDateInput = document.getElementById('Task_Date_edit');
...
<script>
    ...
    function createTaskElement(taskData, id, task = null) {
        ...
        <div class="col-md-12 d-flex m-auto align-items-center gap-1">
            ...
            <input type="text" class="task-title form-control" name="task[${task.id}][subtask][${taskData.id}]" value="${taskData.title}">
        ...
        <div class="col-md-12 d-flex m-auto align-items-center gap-1">
            <span class="drag-handle">&#9776;</span>
            <input type="text" class="task-title form-control" name="task[${taskData.id}][title]" value="${taskData.title}">
            <button class="delete-task btn btn-sm"><i class="fa fa-times" aria-hidden="true"></i></button>
        </div>`;
        }
        ...
        deleteButton.addEventListener("click", () => {
            taskElement.removeChild(taskRow);
        });
