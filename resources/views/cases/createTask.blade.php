...
{{ Form::open(['route' => 'tasks.create', 'method' => 'post', 'enctype' => 'multipart/form-data']) }}
                ...
                <div class="dropdowns_wrapper">
                    <div class="dropdown_icons">
                        ...
                        <div class="from-control">
                            ...
                            {{-- {!! Form::select('task_team[]',$teams->toArray(), request()->isMethod('post') ? old('task_team') : auth()->user()->id, [
                                'class' => 'form-control',
                                'id' => 'task_team',
                                'multiple',
                                'data-role' => 'tagsinput',
