            ...
            <div class="tab-pane fade {{ $tab == 'data' ? ' show active ' : '' }}" id="pills-home" role="tabpanel"
                ...
                <div class="case_tab_content">
                    ...
                    <div class="row">
                                    ...
                                    <div class="case_information_box_list">
                                        <ul>
                                            <li class="list_Info d-flex justify-content-between align-items-start">
                                                ...
                                                <span class="">
                                                    {{ $case->fallSlip->fall_ii_incident_date }}
                                                </span>
                                            </li>
                                            ...
                                            <li class="list_Info d-flex justify-content-between align-items-start">
                                                ...
                                                <span class="">
                                                    {{ $case->fallSlip->fall_ii_location_of_incident }}
                                                </span>
                                            </li>
                                            <li class="list_Info d-flex justify-content-between align-items-start">
                                                <p class="mb-0">
                                            ...
                                            <li class="list_Info d-flex justify-content-between align-items-start">
                                                ...
                                                <span class="">
                                                    {{ $case->fallSlip->fall_ii_maps_link }}
                                                </span>
                                            </li>
                                            <li class="list_Info d-flex justify-content-between align-items-start">
                                                <p class="mb-0">
                                                ...
                                                <span class="">
                                                    {{ $case->fallSlip->fall_ii_cause_incident }}
                                                </span>
                                            </li>
                                        </ul>
                                    </div>
                        ...
                        <div class="col-xl-4">
                            <div class="case_opponents_box custom-scroll" style="height: 96%">
                                <div class="Opponents_title">
                                    <h3>
                                        Witness
                                    </h3>
                                </div>
                                @if (!empty($case->fallSlip->witness))

                                    @foreach (json_decode($case->fallSlip->witness, true) as $key => $opp)
                    ...
                    <div class="row">
                                ...
                                <div class="case_information_box_list">
                                    <ul>
                                        ...
                                        <li
                                            ...
                                            <span class="">
                                                {{ $case->fallSlip->fall_c_marital_status }}
                                            </span>
                                        </li>
                                        <li
                                            class="list_Info list_Info_other d-flex justify-content-between align-items-start">
                                            ...
                                            <span class="">
                                                {{ $case->fallSlip->fall_c_spouse_name }}
                                            </span>
                                        </li>
                                        <li
                                            class="list_Info list_Info_other d-flex justify-content-between align-items-start">
                                            ...
                                            <span class="">
                                                {{ $case->fallSlip->fall_c_emergency_contact_name }}
                                            </span>
                                        </li>
                                        <li
                                            class="list_Info list_Info_other d-flex justify-content-between align-items-start">
                                            ...
                                            <span class="">
                                                {{ $case->fallSlip->fall_c_emergency_contact_number }}
                                            </span>
                                        </li>
                                        <li
                                            class="list_Info list_Info_other d-flex justify-content-between align-items-start">
                                        ...
                                        <li
                                            ...
                                            <span class="">
                                                {{ $case->fallSlip->fall_c_social_security }}
                                            </span>
                                        </li>
                                        <li
                                            class="list_Info list_Info_other d-flex justify-content-between align-items-start">
                                        ...
                                        <li
                                            ...
                                            <span class="">
                                                {{ $case->fallSlip->fall_c_driver_license }}
                                            </span>
                                        </li>
                                        <li
                                            class="list_Info list_Info_other d-flex justify-content-between align-items-start">
                                            ...
                                            <span class="">
                                                {{ $case->fallSlip->fall_c_health_insurance }}
                                            </span>
                                        </li>
                                        <li
                                            class="list_Info list_Info_other d-flex justify-content-between align-items-start">
                        ...
                        <div class="col-xl-6">
                            <div class="case_information_box" style="height: 95%;">
                                <div class="case_information_box_title">
                                    <h3 class="mb-0">
                                ...
                                <div class="case_information_box_list">
                                    <ul>
                                        ...
                                        <li
                                            ...
                                            <span class="">
                                                {{ $case->fallSlip->fall_tpi_address }}
                                            </span>
                                        </li>
                                        <li
                                            class="list_Info list_Info_other d-flex justify-content-between align-items-start">
                                ...
                                <div class="case_information_box_list">
                                    <ul>
                                        <li
                                            ...
                                            <span class="">
                                                {{ $case->fallSlip->fall_ifp_company_name }}
                                            </span>
                                        </li>
                                        <li
                                            class="list_Info list_Info_other d-flex justify-content-between align-items-start">
                                            ...
                                            <span class="">
                                                {{ $case->fallSlip->fall_ifp_insured_name }}
                                            </span>
                                        </li>
                                        <li
                                            class="list_Info list_Info_other d-flex justify-content-between align-items-start">
                                            ...
                                            <span class="">
                                                {{ $case->fallSlip->fall_ifp_poilicy }}
                                            </span>
                                        </li>
                                        <li
                                            class="list_Info list_Info_other d-flex justify-content-between align-items-start">
                                        ...
                                        <li
                                            ...
                                            <span class="">
                                                {{ $case->fallSlip->fall_ifp_insurance_phone }}
                                            </span>
                                        </li>
                                        <li
                                            class="list_Info list_Info_other d-flex justify-content-between align-items-start">
                                            ...
                                            <span class="">
                                                {{ $case->fallSlip->fall_ifp_adjuster_name }}
                                            </span>
                                        </li>
                                        <li
                                            class="list_Info list_Info_other d-flex justify-content-between align-items-start">
                                            ...
                                            <span class="">
                                                {{ $case->fallSlip->fall_ifp_adjuster_email }}
                                            </span>
                                        </li>
                                        <li
                                            class="list_Info list_Info_other d-flex justify-content-between align-items-start">
                                            ...
                                            <span class="">
                                                {{ $case->fallSlip->fall_ifp_adjuster_phone }}
                                            </span>
                                        </li>
                                        <li
                                            class="list_Info list_Info_other d-flex justify-content-between align-items-start">
                                            ...
                                            <span class="">
                                                {{ $case->fallSlip->fall_ifp_adjuster_fax }}
                                            </span>
                                        </li>
                                        <li
                                            class="list_Info list_Info_other d-flex justify-content-between align-items-start">
                                            ...
                                            <span class="">
                                                {{ $case->fallSlip->fall_ifp_adjuster_policy_limits }}
                                            </span>
                                        </li>
                                    </ul>
                                </div>
                                ...
                                <div class="case_information_box_list">
                                    <ul>
                                        <li
                                            ...
                                            <span class="">
                                                {{ $case->fallSlip->fall_itp_company_name }}
                                            </span>
                                        </li>
                                        <li
                                            class="list_Info list_Info_other d-flex justify-content-between align-items-start">
                                            ...
                                            <span class="">
                                                {{ $case->fallSlip->fall_itp_insured_name }}
                                            </span>
                                        </li>
                                        <li
                                            class="list_Info list_Info_other d-flex justify-content-between align-items-start">
                                            ...
                                            <span class="">
                                                {{ $case->fallSlip->fall_itp_poilicy }}
                                            </span>
                                        </li>
                                        <li
                                            class="list_Info list_Info_other d-flex justify-content-between align-items-start">
                                        ...
                                        <li
                                            ...
                                            <span class="">
                                                {{ $case->fallSlip->fall_itp_insurance_phone }}
                                            </span>
                                        </li>
                                        <li
                                            class="list_Info list_Info_other d-flex justify-content-between align-items-start">
                                            ...
                                            <span class="">
                                                {{ $case->fallSlip->fall_itp_adjuster_name }}
                                            </span>
                                        </li>
                                        <li
                                            class="list_Info list_Info_other d-flex justify-content-between align-items-start">
                                            ...
                                            <span class="">
                                                {{ $case->fallSlip->fall_itp_adjuster_email }}
                                            </span>
                                        </li>
                                        <li
                                            class="list_Info list_Info_other d-flex justify-content-between align-items-start">
                                            ...
                                            <span class="">
                                                {{ $case->fallSlip->fall_itp_adjuster_phone }}
                                            </span>
                                        </li>
                                        <li
                                            class="list_Info list_Info_other d-flex justify-content-between align-items-start">
                                            ...
                                            <span class="">
                                                {{ $case->fallSlip->fall_itp_adjuster_fax }}
                                            </span>
                                        </li>
                                        <li
                                            class="list_Info list_Info_other d-flex justify-content-between align-items-start">
                                            ...
                                            <span class="">
                                                {{ $case->fallSlip->fall_itp_adjuster_policy_limits }}
                                            </span>
                                        </li>
                                    </ul>
                                </div>
                                ...
                                <div class="case_information_box_list">
                                    <ul>
                                        <li
                                            ...
                                            <span class="">
                                                {{ $case->fallSlip->fall_o_incident_report }}
                                            </span>
                                        </li>
                                        <li
                                            class="list_Info list_Info_setting_2 d-flex justify-content-between align-items-start">
                                            ...
                                            <span class="">
                                                {{ $case->fallSlip->fall_o_recorded_statements }}
                                            </span>
                                        </li>
                                        <li
                                            class="list_Info list_Info_setting_2 d-flex justify-content-between align-items-start">
                                            ...
                                            <span class="">
                                                {{ $case->fallSlip->fall_o_opponent_counsel }}
                                            </span>
                                        </li>
                                        <li
                                            class="list_Info list_Info_setting_2 d-flex justify-content-between align-items-start">
                                                                ...
                                                                <li
                                                                    ...
                                                                    <span class="">
                                                                        @php
                                                                            ...
                                                                            $editCase = $change_case;
                                                                            
                                                                            // Define a mapping for field name replacements
                                                                            $fieldReplacements = [
                                                                                'Fall C ' => ' Client ',
                                                                                'Fall Tpi ' => ' Third Party Information ',
                                                                                'Fall Mi ' => ' Management Information ',
                                                                                'Fall Ifp ' => ' Insurance First Party ',
                                                                                'Fall Itp ' => ' Insurance Third Party ',
                                                                                'Fall Ii ' => ' Insurance Information ',
                                                                                'Fall O ' => ' Other ',
                                                                            ];
                                                                            
                                                                            // Remove "Case Id" from the list
                                                                            $fieldNames = explode(', ', $editCase);
                                                                            
                                                                            $filteredFieldNames = array_filter($fieldNames, function ($fieldName) {
                                                                                return !str_contains($fieldName, 'Case Id');
                                                                            });
                                                                            
                                                                            // Replace field name parts using the mapping
                                                                            $formattedFieldNames = array_map(function ($fieldName) use ($fieldReplacements) {
                                                                                return strtr($fieldName, $fieldReplacements);
                                                                            }, $filteredFieldNames);
                                                                            
                                                                            $final_change = implode(' | ', $formattedFieldNames);
                                                                        @endphp
                                                                        {{ $final_change }}
                                                                    </span>
                                                                </li>
