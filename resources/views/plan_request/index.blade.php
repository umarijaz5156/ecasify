                        ...
                        <tbody>
                                @foreach($plan_requests as $prequest)
                                    <tr>
                                        ...
                                        <td>
                                            <div class="font-style font-weight-bold">{{ $prequest->name }}</div>
                                        </td>
                                        <td>
                                            <div class="font-weight-bold">{{ $prequest->max_users }}</div>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <div>
                                                ...
                                                <a href="#" class="action-btn bg-light-secondary ms-2 text-dark" data-url="{{route('response.request',[$prequest->id,1])}}" data-size="lg"
                                                    data-ajax-popup="true" data-title="{{__('Accept Plan Request')}}" title="{{__('Accept')}}" data-bs-toggle="tooltip"
