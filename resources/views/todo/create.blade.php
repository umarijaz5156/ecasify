...
{{ Form::open(['route' => 'tasks.create', 'method' => 'post', 'id' => 'taskCreate', 'enctype' => 'multipart/form-data']) }}
        ...
        <div class="row">
            <div class="col-12">
                <div class="mb-3 add_modal_input form-group">
                    ...
                    <input type="text" class="form-control" name="title" required placeholder="Add task title here">
            ...
            <div class="col-md-4 d-flex justify-content-start align-items-start flex-column ">
                ...
                <div class="dropdowns_wrapper">
                    <div class="dropdown_icons">
                        ...
                        <div id="error-message" style="display: none;" class="error-message">You must bind this task with a case in order to save.</div>
                    ...
                    <div class="dropdown_icons">
                        ...
                        <select name="status" class="form-select" aria-label="Default select example" required>
                            <option value="" selected disabled>Task Status
                            </option>
...
<div class="modal-footer">
    ...
    <input type="submit" id="validateButton" value="{{ __('Create') }}" class="btn btn-primary ms-2">
</div>
{{ Form::close() }}
...
<script>
    $(document).ready(function () {
        ...
        $('#validateButton').click(function () {
            // Get the selected value of case_id
...
<script>
    var taskCounter = 0; // Counter for task IDs
    ...
    function updateInputFieldName(taskElement, prevTaskId) {
        ...
        var taskList = document.getElementById("taskList");
        var subtaskElements = taskList.querySelectorAll(".task-list.row.subtask-list");
...
<script>
    $(document).ready(function() {
        ...
        var secondButton = document.getElementById("addTask"); // Assuming the 2nd button has the id "addTask"
