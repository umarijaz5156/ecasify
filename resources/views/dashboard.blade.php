    ...
    <div class="dashboard_main_wrapper" >
        ...
        <div class="">
          <span class=" welcome_text">
            ...
            line-height: 1.2;
            color: #060606;
            font-size: 1.3rem;">Hey {{ UsersNameById($user_id) }}  -</span>
        ...
        <div class="dashboard_cards" style="grid-template-columns: repeat(3, 1fr);" id="sortable-cards">
            ...
            <div class="cards_box" data-card-id='upcomingcase_widget'>
                ...
                <h6 class="card_info">{{ count($upcoming_case)   }}</h6>
              </div>
                ...
                <div class="sortable-inner-container">
                    ...
                    <div class="sortable-item widget_holder_in row-widget" widget-name = 'chart-row'>
                        <div class="form-group d-flex justify-content-end align-items-end gap-2 " >
                            {{-- <h5 class="widget_title">Total Cases</h5> --}}
                    ...
                    <div style="flex:1" class=" sortable-item high_priorty_widget widget_holder_in row-widget"      widget-name = 'task-row'>
                        ...
                        <table class="table table-borderless ">
                            ...
                            <tr>
                                <td > {{ $task->associatedCase->name ?? '' }}</td>
                                <td>{{ $task->status ?? '' }}
                    ...
                    <div>
                        ...
                        <div class="mt-5">
                            <div class="d-flex justify-content-start align-items-center">
                                ...
                                Most Time Logged <b>{{ $maxLoggedTime }} </b> by <b> {{ $maxLoggedMember }}</b>
                                </p>
                            </div>
                        </div>
                    </div>
                          ...
                          <ul class="px-0" style="list-style: none;">
                            ...
                            <li class="mb-3">
                                <div class="d-flex justify-content-between align-items-start gap-2">
                                    @switch($allActivity->target_type)
                                        @case('Case')
                                                <span class="line-clamp-1">{{ $userName }}  {{ $activityDescription }} 
                                                    <a style="text-align: left;padding:0px;color:#116bf1" class="Priority_table_text text-left recent_activity_links" href="{{ isset($allActivity->file) ? route('cases.show', $allActivity->target_id . '?tab=document') : route('cases.show', $allActivity->target_id . '?tab=timeline') }}" class="btn btn-sm d-inline-flex align-items-center" title="" data-bs-toggle="tooltip" data-bs-placement="top">
                                                        {{ $activitytype }}
                                              
                                                    </a>  
                                                    <a style="text-align: left;padding:0px;color:#b443ff" href="{{ route('activities.index')}}" class="btn btn-sm d-inline-flex recent_activity_links align-items-center">
                                                        {{ $activitytag }}    
                                                    </a>    
                                                </span> 
                                        ...
                                        @case('Task')
                                                <span class="line-clamp-1">{{ $userName }} {{ $activityDescription }} 
                                                    <a style="text-align: left;padding:0px;color:#116bf1" href="#" class="Priority_table_text text-left recent_activity_links btn btn-sm d-inline-flex align-items-center"  data-url="{{ route('to-do.show', $allActivity->target_id) }}" data-size="xl addTaskModal_wrapper" data-ajax-popup="true" data-title="{{ $activityDescription }}" title="{{ $activityDescription }}" data-bs-toggle="tooltip" data-bs-placement="top" >
                                                        {{ $activitytype }}
                                                    </a>
                                                    <a style="text-align: left;padding:0px;color:#b443ff" href="{{ route('activities.index')}}" class="btn btn-sm d-inline-flex recent_activity_links align-items-center">
                                                        {{ $activitytag }}    
                                        ...
                                        @case('User')
                                                <span class="line-clamp-1">{{ $userName }} {{ $activityDescription }} 
                                                    <a style="text-align: left;padding:0px;color:#116bf1" href="{{ route('users.edit', $allActivity->target_id) }}" class="Priority_table_text recent_activity_links btn btn-sm d-inline-flex align-items-center" title="" data-bs-toggle="tooltip" data-bs-placement="top">
                                        ...
                                        @case('Timer')
                                            @if (isset($allActivity->target_id))
                                                    <span class="line-clamp-1">{{ $userName }} {{ $activityDescription }} 
                                                        <a style="text-align: left;padding:0px;color:#116bf1" href="#" class="btn btn-sm d-inline-flex recent_activity_links align-items-center"  data-url="{{ route('timesheet.show', $allActivity->target_id) }}" data-size="xl addTaskModal_wrapper" data-ajax-popup="true" data-title="{{ __(' View Timesheet') }}" title="{{ __('View Timesheet') }}" data-bs-toggle="tooltip" data-bs-placement="top" >
                                                        {{ $activitytype }}
                                                    </a>
                                                ...
                                                <div  class="Priority_table_text recent_activity_links">
                                                    <span class="line-clamp-1" style="text-align: left;padding:0px">{{ $userName }} {{ $activityDescription }} {{ $activitytype }}</span>
                                                </div>
                                            @endif
                                    ...
                                    <p class="recent_activity_time mb-0">{{ timeAgo($allActivity->created_at) }}</p>
                                </div>
                            </li>
                        @endforeach
                    ...
                    <div class="drag-handle h-100" >
                        ...
                        <div class="mini_calendar_wrapper h-100">
                            ...
                            <div  class="text-end p-2" id="calender_id">
                                {{-- <button style="font-size: 4px;padding: 3px;"
                                type="button"
                                class="btn btn-sm btn-primary"
                                data-bs-toggle="modal"
                                data-bs-target="#calendarmodelA"
                                data-toggle="tooltip"
                              title="{{ __('Create Event') }}" data-bs-original-title="{{ __('Create Event') }}" data-bs-placement="top"
                    ...
                    <div class="p-3">
                        <div class="d-flex justify-content-between mb-3">
                            ...
                            <div>
                                ...
                                @if ('manage case')
                                    <h6 class="mb-0"><a href="{{ route('cases.index') }}">
                    ...
                    <div class="p-3">
                        <div class="d-flex justify-content-between mb-3">
                            ...
                            <div>
                                ...
                                <h6 class="mb-0"><a href="{{ route('advocate.index') }}">
                                        <span class="dash-mtext">{{ __('Attorneys') }}</span>
                                    </a></h6>
                            </div>
                        </div>
                ...
                <div class="col border-end border-bottom">
                    <div class="p-3">
                        <div class="d-flex justify-content-between mb-3">
                            ...
                            <div>
                                <p class="text-muted text-sm mb-0">{{ __('Total') }}</p>
                                <h6 class="mb-0"><a href="{{ route('users.index') }}" >
                                        <span class="dash-mtext">{{ __('Team Members') }}</span>
                                    </a></h6>
                            </div>
                        </div>
                ...
                <div class="col border-end border-bottom">
                    <div class="p-3">
                        <div class="d-flex justify-content-between mb-3">
                            ...
                            <div>
                                <p class="text-muted text-sm mb-0">{{ __('Total') }}</p>
                                <h6 class="mb-0"><a href="{{ route('tasks.index') }}" >
                            ...
                            <div class="card-body p-0">
                                <div class="scroll-add">
                                    <ul class="list-group list-group-flush" id="todayhear">
                                        ...
                                        @if (count($cases) > 0)
                                            @foreach ($cases as $key => $upcoming)
                                                <li class="list-group-item">
                                                    <div class="row align-items-center justify-content-between">
                                                        <div class="col-sm-auto mb-3 mb-sm-0">
                                                            <a href="{{ route('cases.show', $upcoming->id) }}">
                                                                {{ !empty($upcoming->name) ? $encryptionHelper->decryptAES($upcoming->name) : ' ' }}
                                                            </a>
                            ...
                            <div class="card-body p-0">
                                <div class="scroll-add">
                                    <ul class="list-group list-group-flush" id="todaytodo">
                                        ...
                                        @if (count($todos) > 0)
                                            @foreach ($todos as $upcoming)
                                                <li class="list-group-item">
                                                    <div class="row align-items-center justify-content-between">
                                                        <div class="col-sm-auto mb-3 mb-sm-0">
                                                            <a
                                                                href="{{ route('tasks.index', ['task_id' => $upcoming->id]) }}">
                                                                {{ !empty($upcoming['title']) ? $upcoming['title'] : ' ' }}
                                                            </a>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group col-md-12">
                    {!! Form::label('case', __('Select Case'), ['class' => 'form-label']) !!}
...
// cards js
    document.addEventListener('DOMContentLoaded', function () {
        ...
        var userPositions = {!! json_encode($widgetsPositions) !!}; // Retrieve user's card positions
...
const widgetPositions = @json($widgetsPositions);
...
<script>
    ...
    $(document).ready(function () {
            ...
            function updateMostTimeLoggedData(startDate, endDate) {
                var url = "{{ route('getTimesheetData', ':startDate/:endDate') }}";
    ...
    var myChart = null;
                        ...
                        function updateChartData(startDate, endDate) {
                            ...
                            var url = "{{ route('update.graph', ':startDate/:endDate') }}";
                            url = url.replace(':startDate', startDate);
                             url = url.replace(':endDate', endDate);
                             $.ajax({
                                url: url,
