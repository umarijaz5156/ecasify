...
<div class="modal-body">
    <div class="row">
        <div class="form-group col-md-12">
            ...
            {!! Form::text('title', null, ['class' => 'form-control','placeholder' => 'Expense Title']) !!}
        </div>
        <div class="form-group col-md-12">
        ...
        <div class="form-group col-md-12">
            ...
            {!! Form::number('money', null, ['class' => 'form-control','placeholder' => 'Money Spent']) !!}
        </div>
        <div class="form-group col-md-12">
            {!! Form::label('type', __('Expense Type'), ['class' => 'form-label']) !!}
            {!! Form::select('type',$expensetype, null, ['class' => 'form-control','placeholder' => 'Please Select Expense Type']) !!}
        </div>
        <div class="form-group col-md-12">
        ...
        <div class="form-group col-md-12">
           ...
           {!! Form::select('case',$cases, null, ['class' => 'form-control', 'placeholder'=> 'Cases' ]) !!}
        </div>
        {{-- attachement use filepond--}}
        <div class="form-group col-md-12">
...
<script>
    ...
    $(document).ready(function() {
       // Initialize FilePond with configuration options
