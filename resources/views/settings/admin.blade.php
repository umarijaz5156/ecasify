            ...
            <div class="col-xl-3 border-end border-bottom">
                <div class="card shadow-none bg-transparent sticky-top" style="top:70px">
                    <div class="list-group list-group-flush rounded-0" id="useradd-sidenav">
                        <a href="#useradd-1" class="list-group-item list-group-item-action">{{ __('Company Onboarding') }}
                ...
                <div class="card shadow-none rounded-0 border-bottom" id="useradd-2">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    {{ Form::label('mail_driver', __('SMTP/IMAP/POP'), ['class' => 'form-label']) }}
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    {{ Form::label('mail_host', __('Outgoing Server'), ['class' => 'form-label']) }}
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    {{ Form::label('mail_port', __('Outgoing Port'), ['class' => 'form-label']) }}
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    {{ Form::label('mail_username', __('Username'), ['class' => 'form-label']) }}
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    {{ Form::label('mail_password', __('Password'), ['class' => 'form-label']) }}
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    {{ Form::label('mail_encryption', __('Encryption Type'), ['class' => 'form-label'])
                                    }}
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    {{ Form::label('mail_from_address', __('Mailing Address'), ['class' =>
                                    'form-label']) }}
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    {{ Form::label('mail_from_name', __('From Mail Title'), ['class' => 'form-label']) }}
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" id="discardChangesButton">Discard Changes</button>
            ...
            $.each(result.data, function(key, value) {
                ...
                setTimeout(function() {
                    if (value.id == '{{ $country_id }}') {
                        $("#country").append('<option value="'+value.id+'" selected class="counties_list">' + value.name.charAt(0).toUpperCase() + value.name.slice(1) + '</option>');
                    }else{
                        $("#country").append('<option value="'+value.id+'" class="counties_list">' + value.name.charAt(0).toUpperCase() + value.name.slice(1) + '</option>');
                    }
                }, 1000);
        ...
        success: function(result) {
            setTimeout(function() {
                $.each(result, function(key, value) {
                    const capitalizedStateName = value.name.charAt(0).toUpperCase() + value.name.slice(1);
                    
                    // Create the option element
                    const option = $('<option>', {
                        value: value.id,
                        text: capitalizedStateName
                    });
                    
                    // Check if the current state matches the state_id parameter
                    if (value.id == stateId) {
...
$(document).on("click",'a[data-ajax-popup="true"], button[data-ajax-popup="true"], div[data-ajax-popup="true"]',function () {
    ...
    $.ajax({
        ...
        success: function(result) {
            ...
            $.each(result.data, function(key, value) {
                setTimeout(function() {
                    $("#state_country").append('<option value="' + value.id + '" >' + value.name.charAt(0).toUpperCase() + value.name.slice(1) + '</option>');
                }, 1000);
...
@endif
    ...
    $(document).ready(function() {
        ...
        $('form input').on('change', function() {
            ...
            if (!formsToSubmit.includes(form)) {
                formsToSubmit.push(form);
            }
        });

        document.addEventListener('visibilitychange', function() {
            if (document.visibilityState === 'hidden' && formChanged) {
                showModal();
            }
        });
        ...
        function submitForms(forms) {
            var promises = forms.map(function(form) {
                return new Promise(function(resolve, reject) {
                    $.ajax({
                        url: form.attr('action'), // Assuming action attribute is set
                        method: form.attr('method'), // Assuming method attribute is set
                        data: form.serialize(),
                        success: function() {
                            resolve();
                        },
