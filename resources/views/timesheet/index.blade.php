...
@section('page-title', $isDraftView ?? false ? __('Timesheet Drafts') : __('Timesheet'))

@section('action-button')
@can('create timesheet')
<div class="text-sm-end d-flex all-button-box justify-content-sm-end">
    <a href="#" class="btn btn-sm btn-primary mx-1" data-ajax-popup="true" data-size="md" data-title="Add Manual Time"
...
@section('breadcrumb')
<li class="breadcrumb-item">{{ $isDraftView ?? false ? __('Timesheet Drafs') : __('Timesheet') }}</li>
@endsection
