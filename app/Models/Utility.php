...
class Utility extends Model
{
    ...
    public static function getValByName($key,$user_id = null)
    {
        $setting = !empty($user_id) ? Utility::settings($user_id) : Utility::settings();
    ...
    public static function languages()
    {
        ...
        if(Schema::hasTable('languages')){
            ...
            if(!empty($settings['disable_lang'])){
                ...
                $languages = Languages::whereNotIn('fullName',$disabledlang)->pluck('fullName','code');
    ...
    public static function get_company_logo()
    {
        ...
        if ($is_dark_mode == 'on') {
            ...
            $data = DB::table('settings')->where('created_by', $user->id)->where('name','company_logo_light')->first('value');
           ...
           return  $data;
            ...
            $data = DB::table('settings')->where('created_by', $user->id)->where('name','company_logo_dark')->first('value');
        ...
        try {
            ...
            if (!empty($settings['storage_setting'])) {
                ...
                if ($validator->fails()) {
                    ...
                    } else if ($settings['storage_setting'] == 'public'){

                     
                        // $multifile[$key_name]->move(public_path($path), $name);

                        $multifile[$key_name]->storeAs(
                            $path,
                            $name,
                            'public' 
                        );
